...
版 <- llply(集, function(迭) {
    ...
    if (!is.null(牍$'居民储蓄（亿人民币）')) {
      牍$'居民储蓄（亿人民币）' * 100000000
      }
    牍 <- plyr::rename(牍, replace = c('居民储蓄（亿人民币）', '居民储蓄'))
    ...
    if (!is.null(牍$'本外币余额（亿人民币）')) {
      牍$'本外币余额（亿人民币）' * 100000000
    }
    牍 <- plyr::rename(牍, replace = c('本外币余额（亿人民币）', '本外币余额'))
